...
import {ReactComponent as CalTemp} from '../svg/cal.svg';
        ...
        return (
            <Search className="d-flex justify-content-center"> 
                <SearchContents className="d-flex">
                    {/*<Cal src="/live/cal.svg" /> Timeline*/}
                    <ScheduleHeader><Cal src="/live/cal.svg" /></ScheduleHeader>
