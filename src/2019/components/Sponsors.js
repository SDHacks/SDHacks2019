...
import { Page, Container, SectionContent, SectionHeader } from "../styles";
...
const SponsorsSection = styled(Page)`
  background: url("/sea-animals/silhouette.svg"),
    ${SponsorsConstants.background};
          ...
          <SectionContent>
            <div className="container-fluid">
              <div className="row justify-content-center">
                <SectionHeader>Previous Sponsors</SectionHeader>
              </div>
              <SponsorContent>
